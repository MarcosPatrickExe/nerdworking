        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Nerdworking',
                style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 25.0, fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 80.0),
              FormFieldComponent.buildField(
                fieldView: const Field("Email", "e-mail", Icon(Icons.email_outlined), TextInputType.emailAddress),
                currentIndex: buildContext,
                textChagedCallback: (String value) {
              ...
              const SizedBox(height: 30.0),
              FormFieldComponent.buildField(
                fieldView: const Field("Senha", "senha", Icon(Icons.password_rounded), TextInputType.visiblePassword),
                currentIndex: buildContext,
                textChagedCallback: (String value) {
                ...
                Container(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        ...
                        backgroundColor: WidgetStateProperty.all<Color>( Provider.of<AppThemeProvider>(super.context, listen: false).currentThemeData.colorScheme.primary   ),
                        shape: WidgetStateProperty.all<OutlinedBorder>(//  MaterialStateProperty.all  ->  RoundedRectangleBorder(
                            const RoundedRectangleBorder(  borderRadius: BorderRadius.all( Radius.circular(30.0)), )
                        ),
                      ),
                      onPressed: () {
                        ...
                        print('\nTEMA ALTERADO PARA ${AppThemeProvider.currentTheme }'); // Provider.of<AppThemeProvider>( buildContext, listen: false ).currentThemeData 
                      },
                      child: const Row( mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                        Icon(  Icons.add, ),
                        const SizedBox(width: 10.0),
                        Text( "Criar conta", style: TextStyle( fontSize: 17.0,  ),  ),
                      ]),
                    )
                ),
              ]),
